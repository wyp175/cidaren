...
*/
    ...
    {
        FiddlerApplication.Log.LogString("[日志消息]: "+msg);
    ...
    static function cidaren(os: Session)
    {
        ...
        if(jsonString!='[]'&&jsonString!='{}' ){
            ...
            if((responseJSON.JSONObject=='System.Collections.ArrayList' || responseJSON.JSONObject=='System.Collections.Hashtable')){
                if (responseJSON.JSONObject['data'] != null && responseJSON.JSONObject['data']['answer_state']!=null && responseJSON.JSONObject['data']['topic_mode']!=null) {
